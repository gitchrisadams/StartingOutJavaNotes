package com.christopheradams.num013Menus;
...
public class MenuWindow extends JFrame
{
   ...
   */
   ...
   public MenuWindow()
   {
      ...
      // This means the size will be adjusted as needed depending on its contents.
      // The (LABEL_WIDTH, LABEL_HEIGHT) set the preferred size.
