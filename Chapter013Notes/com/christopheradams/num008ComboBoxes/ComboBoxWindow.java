package com.christopheradams.num008ComboBoxes;
...
public class ComboBoxWindow extends JFrame
{
   ...
   */
   ...
   private void buildCoffeePanel()
   {
      ...
      /***** End Create the combo box *****/
      
      /***** Combo boxes are uneditable by default. We will *****/
      /***** now make the combo box editable for demonstration purposes *****/
