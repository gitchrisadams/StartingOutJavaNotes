package com.christopheradams.num004ListWithBorder;
...
public class ListWindowBorders extends JFrame
{
   ...
   */
   ...
   public ListWindowBorders()
   {
      ...
      // Pack automatically resizes the window to accommodate components.
      pack();
      setVisible(true);
   }
   ...
   */
   ...
   private void buildMonthPanel()
   {
      ...
      /***** Add a 3 pixel border around the list *****/
      monthList.setBorder(BorderFactory.createLineBorder(Color.BLACK, 3));
      
      /***** End Add a 3 pixel border around the list *****/
