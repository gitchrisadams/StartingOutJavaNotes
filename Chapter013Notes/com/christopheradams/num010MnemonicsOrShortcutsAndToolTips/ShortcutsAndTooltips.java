package com.christopheradams.num010MnemonicsOrShortcutsAndToolTips;
...
public class ShortcutsAndTooltips extends JFrame
{
	/***** Fields *****/
	// Create 6 panels:
	...
	public void buildPanel()
	{
		...
		/***** Create a Alt+shortcut or mnemonic so when the *****/
		/***** Alt-C button is pressed the button will do the calculate action. *****/
		// The VK stands for virtual keyboard and the C is the key to be used.
		calcButton.setMnemonic(KeyEvent.VK_C);
		
		/***** End Create Alt+shortcut / mnemonic *****/
		
		/***** Setup a tool tip to display for the calculate button *****/
		calcButton.setToolTipText("Click here to calculate.");
