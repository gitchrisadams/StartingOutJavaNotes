package com.christopheradams.num006AddingItemsToExistingList;
...
public class ListWindowReplacingItemsInExistingList extends JFrame
{
   ...
   private JButton replaceListButton; // A button replace items in a list.
   ...
   /***** Create a new array to replace our list with: *****/
   private String[] evilMonths = {"Evil December", "Evil October"};
   ...
   */
   ...
   public ListWindowReplacingItemsInExistingList()
   {
      // Set the title.
      setTitle("List Demo");
   ...
   */
   ...
   {
	   // Create new button object to replace items in list:
	   replaceListButton = new JButton("Replace items!");
	   
	   /***** Create action Listener to replace item in list when *****/
	   /***** button is clicked: *****/
	   replaceListButton.addActionListener(new ReplaceButtonListener());
   ...
   */
   ...
   private void buildSelectedMonthPanel()
   {
      ...
      selectedMonthPanel.add(replaceListButton);
   }
   
   /**
    * When the button is clicked it replaces items in the list.
    * @author Christopher
    *
    */
   private class ReplaceButtonListener implements ActionListener
   {
	   ...
	   {
		   monthList.setListData(evilMonths);
	   }
   }
   ...
   */
     ...
     {
        new ListWindowReplacingItemsInExistingList();
     }
}
