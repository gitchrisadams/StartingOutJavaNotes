package com.christopheradams.num016Borders;
...
public class MetricConverter extends JFrame
{
   ...
   */
   ...
   private void buildPanel()
   {
      ...
      /***** Add an empty border to the panel: *****/
      // This creates a 50 pixel empty border(like padding).
      //panel.setBorder(BorderFactory.createEmptyBorder(50, 50, 50, 50));

      /***** Add a lined border to the panel *****/
      // Format:  panel.setBorder(BorderFactory.createLineBorder(Color.RED, int thickness));
      // Where Color.RED is Color.WHATEVER and thickness is thickness of the line.
      //panel.setBorder(BorderFactory.createLineBorder(Color.RED, 5));

      /***** Add a Titled border *****/
      // An etched border with a title on it.
