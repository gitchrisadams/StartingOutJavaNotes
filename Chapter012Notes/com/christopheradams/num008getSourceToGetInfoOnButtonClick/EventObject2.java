package com.christopheradams.num008getSourceToGetInfoOnButtonClick;
   ...
   */
   ...
   private class ButtonListener implements ActionListener
   {
      public void actionPerformed(ActionEvent e)
      {
         ...
         // a message.
         // Notice we use the getSource and the name of the button
         // variable name. Not the label text on the button like when
         // using the getActionCommand.
