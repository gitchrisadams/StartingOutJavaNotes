package com.christopheradams.num011BorderLayoutButtonsRetainSizeTechnique;
...
/**
   ...
   The buttons inside the pane will retain their size when
   window is resized.
*/
...
public class BorderPanelWindow extends JFrame
{
   ...
   */
   ...
   public BorderPanelWindow()
   {
      ...
      // The pack() method automatically resizes the windows to
      // fit the components contained inside it.
      pack();
      setVisible(true);
   }
