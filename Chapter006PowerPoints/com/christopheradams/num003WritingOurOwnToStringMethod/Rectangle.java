...
public class Rectangle
{
	...
	*/
	...
	/**
		The toString method formats how our Rectangle will be displayed.
		@return The formatting of the Rectangle.
	*/
	public String toString()
	{
		String formattedString; 		// The string formatted.
		formattedString = "["+length+", "+width+"]";
	...
	/**
		The describeRect method displays information about Rectangle passed in.
		@parm theRect The Rectangle object to describe.
	*/
	public void describeRect(Rectangle theRect)
	{
		System.out.println("This Rectangles length is" + theRect.getWidth());
		System.out.println("This Rectangles width is" + theRect.getLength());
	}
