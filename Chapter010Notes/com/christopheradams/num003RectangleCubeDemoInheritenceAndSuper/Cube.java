package com.christopheradams.num003RectangleCubeDemoInheritenceAndSuper;

/**
   This class holds data about a cube.
*/

// Notice it extends Rectangle. We inherit from Rectangle class.
public class Cube extends Rectangle
{
   ...
   */
   ...
   public Cube(double len, double w, double h)
   {
      ...
      // So this calls the Rectangle class 2-arg Constructor.
      super(len, w);
