package com.christopheradams.num007ProtectedAccessModifier;
...
// Notice this class extends GradedActivity.
// This means we have access to the protected score field.
public class FinalExam2 extends GradedActivity2
{
   ...
   */
   ...
   private void adjustScore()
   {
      ...
      /* Since we extended the GradedActivity Class,
         this class is a subclass so it has direct
         access to the protected score field. */
      if (fraction >= 0.5)
